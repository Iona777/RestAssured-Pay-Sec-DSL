...
/**
 * The response when a HSM managed encryption key was successfully created.
 *
...
public class EncryptionKeyResponseResource {

    /**
     * The unique id of the cryptographic key.
     */
    private String id;
